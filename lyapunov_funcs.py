...
"""
modification of the dynamics for cartpole,
but otherwise the same search for a lyapunov function as done here:
https://colab.research.google.com/github/RussTedrake/underactuated/blob/master/lyapunov.ipynb
"""
...
# V must be Positive definite away from x0 (specifically, SOS) (TODO: ask on piazza abt this)
eps = 1e-4
...
constraint2 = prog.AddSosConstraint(-Vdot - L * (s**2 + c**2 - 1) -L_2 * (z*(m_c + m_p*(s**2)) - 1) - eps * (x - x0).dot(x - x0) * s**2)
